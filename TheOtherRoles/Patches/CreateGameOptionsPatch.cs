...
internal class CreateGameOptionsPatch
{
    ...
    private static class CreateGameOptionsOpenShowPatch
    {
    ...
    public static class CreateGameOptionsStartPatch
    {
        private static void Postfix(CreateGameOptions __instance)
        {
            if (SubmergedCompatibility.LoadedExternally) return;
            ...
            modeButtonGS.OnMouseOver.AddListener((Action)(() =>
                __instance.tooltip.SetText(
                    "The <b>Guesser-Gamemode</b> is an extension to the Classic-Gamemode and gives you a multitude of new options for Guessers.")));
            ...
            modeButtonHK.OnMouseOver.AddListener((Action)(() =>
                __instance.tooltip.SetText(
                    "The <b>Hide 'n Seek-Gamemode</b> is a standalone Gamemode where Hunter have to catch their prey (\"Hunted\" players).")));
            ...
            changeButtonText(modeButtonPH, "TOR Pron Hunt");
            ...
            modeButtonPH.OnMouseOver.AddListener((Action)(() =>
                __instance.tooltip.SetText(
                    "The <b>Prop-Gamemode</b> is a standalone Gamemode where Hunters have to find the disguised players (\"Props\").")));
        ...
        {
            passiveButton.transform.FindChild("SelectedInactive/ClassicText").gameObject
                .GetComponentInChildren<TextTranslatorTMP>().Destroy();
            passiveButton.transform.FindChild("Inactive/ClassicText").gameObject
                .GetComponentInChildren<TextTranslatorTMP>().Destroy();
            passiveButton.transform.FindChild("Highlight/ClassicText").gameObject
                .GetComponentInChildren<TextTranslatorTMP>().Destroy();
            passiveButton.transform.FindChild("SelectedHighlight/ClassicText").gameObject
                .GetComponentInChildren<TextTranslatorTMP>().Destroy();

            passiveButton.transform.FindChild("SelectedInactive/ClassicText").gameObject
                .GetComponentInChildren<TMP_Text>().SetText(buttonText);
            passiveButton.transform.FindChild("Inactive/ClassicText").gameObject.GetComponentInChildren<TMP_Text>()
                .SetText(buttonText);
            passiveButton.transform.FindChild("Highlight/ClassicText").gameObject.GetComponentInChildren<TMP_Text>()
                .SetText(buttonText);
            passiveButton.transform.FindChild("SelectedHighlight/ClassicText").gameObject
                .GetComponentInChildren<TMP_Text>().SetText(buttonText);
        }
    ...
    {
        private static string getModeText(CustomGamemodes customGamemodes)
        {
        ...
        private static void Postfix(CreateGameOptions __instance)
        {
            ...
            __instance.containerConfirm.GetChild(5).GetChild(2).GetComponent<TextMeshPro>()
                .SetText(getModeText(TORMapOptions.gameMode));
        }
    }
}